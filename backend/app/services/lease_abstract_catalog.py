...
CLAUSE_CATEGORIES: list[dict] = [
    ...
    {
        "key": "square_footage",
        "name": "Area/Square Footage Information",
        "group": "financial",
        "order": 10,
        "fields": [
            _f("rentable_sf", "Rentable SF", "number"),
            _f("usable_sf", "Usable SF", "number"),
            _f("common_area_factor", "Common Area Factor %", "percent"),
            _f("load_factor", "Load Factor %", "percent"),
            _f("measurement_standard", "Measurement Standard"),
            _f("employee_count", "Employee Count", "number"),
            _f("employee_capacity", "Employee Capacity", "number"),
            _f("employee_excess_capacity", "Employee Excess Capacity", "number"),
            _f("unutilized_space_sf", "Unutilized Space SF", "number"),
            _f("area_per_employee_usable", "Area per Employee Count (Useable) SF", "number"),
            _f("area_per_employee_rentable", "Area per Employee Count (Rentable) SF", "number"),
            _f("has_storage_area", "Has Storage Area", "boolean"),
            _f("storage_area_sf", "Storage Area SF", "number"),
            _f("estimated_space_needs_sf", "Estimated Space Needs SF", "number"),
            _f("lease_prorata", "Lease Prorata %", "percent"),
            _f("comments", "Comments", "textarea"),
            _f("lease_section_clause_reference", "Lease Section / Clause Reference"),
            _f("lease_clause", "Lease Clause"),
            *_summary(),
        ],
    },
    {
        "key": "commencement_expiration",
        "name": "Commencement/Expiration",
        "group": "financial",
        "order": 15,
        "fields": [
            _f("lease_term_months", "Lease Term (Months)", "number"),
            _f("lease_commencement", "Lease Commencement", "date"),
            _f("expiration", "Expiration", "date"),
            _f("original_commencement", "Original Commencement", "date"),
            _f("original_expiration", "Original Expiration", "date"),
            _f("termination", "Termination", "date"),
            _f("rent_commencement", "Rent Commencement", "date"),
            _f("tenant_move_in_date", "Tenant Move In Date", "date"),
            *_summary(),
        ],
    },
    {
