...
app.include_router(hvac_contracts.router, prefix="/api/v1/hvac-contracts", tags=["HVAC Contracts"])
app.include_router(reports.router, prefix="/api/v1/reports", tags=["Reports"])
app.include_router(dashboard.router, prefix="/api/v1/dashboard", tags=["Dashboard"])
app.include_router(users.router, prefix="/api/v1/users", tags=["Users"])
app.include_router(attachments.router, prefix="/api/v1", tags=["Attachments"])
app.include_router(ticket_categories.router, prefix="/api/v1/ticket-categories", tags=["Ticket Categories"])
app.include_router(maintenance_tickets.router, prefix="/api/v1/maintenance-tickets", tags=["Maintenance Tickets"])
...
app.include_router(wizard_configs.router, prefix="/api/v1/wizard-configs", tags=["Wizard Configs"])
app.include_router(vendors.router, prefix="/api/v1/vendors", tags=["Vendors"])
app.include_router(imports.router, prefix="/api/v1/imports", tags=["Imports"])
app.include_router(email_rules.router, prefix="/api/v1/email-rules", tags=["Email Rules"])
app.include_router(trash.router, prefix="/api/v1/admin/trash", tags=["Admin - Trash"])
app.include_router(site_settings.router, prefix="/api/v1/site-settings", tags=["Site Settings"])
app.include_router(ticket_templates.router, prefix="/api/v1/ticket-templates", tags=["Ticket Templates"])
app.include_router(recurring_ticket_rules.router, prefix="/api/v1/recurring-ticket-rules", tags=["Recurring Ticket Rules"])
app.include_router(notifications.router, prefix="/api/v1/notifications", tags=["Notifications"])
app.include_router(organizations.router, prefix="/api/v1/organizations", tags=["Organizations"])
app.include_router(billing.router, prefix="/api/v1/billing", tags=["Billing"])
app.include_router(api_keys.router, prefix="/api/v1/api-keys", tags=["API Keys"])
app.include_router(webhooks.router, prefix="/api/v1/webhooks", tags=["Webhooks"])
app.include_router(operating_expenses.router, prefix="/api/v1/operating-expenses", tags=["Operating Expenses"])
app.include_router(vendor_portal.router, prefix="/api/v1", tags=["Vendor Portal"])
app.include_router(insurance_certificates.router, prefix="/api/v1/insurance-certificates", tags=["Insurance Certificates"])
app.include_router(ws.router, tags=["WebSocket"])
app.include_router(work_order_costs.router, prefix="/api/v1", tags=["Work Order Costs"])
...
app.include_router(ap.router, prefix="/api/v1/ap", tags=["Accounts Payable"])
