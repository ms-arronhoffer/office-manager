...
const entities: Record<string, EntityDef[]> = {
  'Office Management': [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'quarem_date', type: 'Date', required: false, description: 'Quarem system date' },
        { name: 'quarem_status', type: 'Text', required: false, description: 'Quarem system status' },
  ...
  System: [
    ...
    {
      table: 'wizard_configs',
      description: 'Decision Portal wizard flow configurations (JSON-based step definitions).',
      softDelete: false,
      fields: [
        { name: 'id', type: 'UUID', required: true, description: 'Primary key' },
        { name: 'name', type: 'String(200)', required: true, description: 'Wizard name' },
        { name: 'description', type: 'Text', required: false, description: 'Wizard description' },
        { name: 'steps', type: 'JSONB', required: true, description: 'JSON step definitions (branching flow)' },
        { name: 'is_active', type: 'Boolean', required: true, description: 'Whether wizard is active (default: true)' },
        { name: 'is_default', type: 'Boolean', required: true, description: 'Default wizard for portal (default: false)' },
        { name: 'created_at', type: 'DateTime', required: true, description: 'Record creation timestamp' },
        { name: 'updated_at', type: 'DateTime', required: true, description: 'Last update timestamp' },
      ],
      relationships: [],
