    ...
    articles: [
      ...
      },
      {
        ...
        steps: [
          ...
          'For consent-based financial verification, choose Request financial verification on an eligible application. Confirm the applicant email, then send the private request.',
          'The applicant reviews the disclosure before connecting through Plaid. Portfolio Desk retains only identity and ownership match indicators, aggregate balances, and an estimated recurring monthly income summary.',
          'Review the Plaid result separately from background screening. It is decision support and never approves or denies an application automatically.',
